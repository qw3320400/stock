...
// go run src/stock-go/main.go -command strategy tag default code sh.000300 start_date 2015-05-01 end_date 2020-10-31
// go run src/stock-go/main.go -command strategy tag weekday code sh.000300 start_date 2015-05-01 end_date 2020-10-31 day_count 5
